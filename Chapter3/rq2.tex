...
% Height-capped as well as width-capped: the caption and the note below leave
% roughly 0.7\textheight for the body, and an uncapped \resizebox overflowed it.
...
LAMD~\cite{Qian2025-ua}                 & AndroZoo                          & 13{,}794 & F1, FPR, FNR   & $>$4 VT engines flag the sample             & \textbf{Temporal} (train 2014--2020, test 2020--23) & Static only (sliced CFG)                              & Three-tier reasoning with Data Relationship Coverage verification \\
