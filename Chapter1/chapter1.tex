...
Chapter~\ref{Chapter2} reviews background concepts and related work on
Android malware detection and LLM-based approaches.
Chapter~\ref{Chapter3} presents the proposed evaluation methodology.
Chapter~\ref{Chapter4} reports and discusses the experimental results.
Chapter~\ref{Chapter5} concludes the thesis and outlines future work.
